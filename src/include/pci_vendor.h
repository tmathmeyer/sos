...
pci_vendors.h: PCI Vendors, Devices, and Class Type information
...
typedef struct
{
    ...
    const char *    ven_short ;
    const char *    ven_full ;
} pci_ventable_t, *ppci_ventable_t ;

pci_ventable_t pci_vendor_table [] =
{
...
#define    PCI_VENTABLE_LEN    (sizeof(pci_vendor_table)/sizeof(pci_ventable_t))
...
}  pci_devtable_t, *ppci_devtable_t;
typedef pci_devtable_t pci_devtable_entry_t;

pci_devtable_t pci_device_table [] =
{
...
// Use this value for loop control during searching:
#define    PCI_DEVTABLE_LEN    (sizeof(pci_device_table)/sizeof(pci_devtable_t))
